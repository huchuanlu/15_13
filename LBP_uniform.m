...
Xi1 = w1*p1+ p2+p4 + p5 + 0.000001;     %%Right and Down   ？？左上
Xi2(3:sy+2,2:sx+1) = X;                 %%Down         ？？上   
Xi3 = w1*p3 + p2 + p6 + p5 + 0.000001;  %%Left and Down  ？？右上
Xi4(2:sy+1,1:sx) = X;                   %%Left         ？？右
Xi5 = w1*p9 + p8 + p6 + p5 + 0.000001;  %%Left and Up    ？？ 右下
Xi6(1:sy,2:sx+1) = X;                   %%Up            ？？下
Xi7 = w1*p7 + p8 + p4 + p5 + 0.000001;  %%Right and Up   ？？左下
Xi8(2:sy+1,3:sx+2) = X;                 %%Right       ？？左
...
%%保留01翻转少于两次的编码;  
%%59/256;
%%实验结果证明:Uniform模式不仅能够描述绝大部分纹理信息,而且具有较强的分类能力;
